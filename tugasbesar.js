...
//     const apiUrl = `https://api.betabotz.eu.org/api/download/yt?url=${encodeURIComponent(args[0])}&apikey=konto`;
...
//     // Destructure the new result from the API response
//     let { title, description, thumb, mp3, mp4, duration } = data.result;
    
//     // Construct the message text with the new response fields
//     let txt = `*${title}*\n\n`
...
//                 {
//                   "name": "quick_reply",
//                   "buttonParamsJson": JSON.stringify({ "display_text": "📹 VIDEO", "id": `${usedPrefix}ytv ${mp4}` })
//                 },
//                 {
//                   "name": "quick_reply",
//                   "buttonParamsJson": JSON.stringify({ "display_text": "🎵 AUDIO", "id": `${usedPrefix}yta ${mp3}` })
//                 }
//               ]
//             })
//           })
